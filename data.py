...
# If included then these are included List:
# So we also need to determine which main variables are in which section:
# trying to find where I classify the main variables ...

# Which variables need to be included in the subset. This was retrieved from the ServiceConfig.pm
support = {}
